...
| Name | Type |
|------|------|
| [aws_alb.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/alb) | resource |
| [aws_cloudwatch_log_group.miggo](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/cloudwatch_log_group) | resource |
| [aws_cloudwatch_log_stream.collector_log_stream](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/cloudwatch_log_stream) | resource |
| [aws_ecs_cluster.miggo](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/ecs_cluster) | resource |
| [aws_ecs_service.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/ecs_service) | resource |
| [aws_ecs_task_definition.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/ecs_task_definition) | resource |
| [aws_iam_policy.task_exec_role](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/iam_policy) | resource |
| [aws_iam_role.task_exec_role](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/iam_role) | resource |
| [aws_lb_listener.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/lb_listener) | resource |
| [aws_lb_target_group.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/lb_target_group) | resource |
| [aws_route53_record.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/route53_record) | resource |
| [aws_security_group.alb_collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/security_group) | resource |
| [aws_security_group.collector](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/security_group) | resource |
| [aws_caller_identity.current](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/caller_identity) | data source |
| [aws_ecs_cluster.provided](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/ecs_cluster) | data source |
| [aws_region.current](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/region) | data source |
| [aws_route53_zone.selected](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/route53_zone) | data source |
| [aws_secretsmanager_secret.dockerhub](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/secretsmanager_secret) | data source |
| [aws_secretsmanager_secret.miggo](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/secretsmanager_secret) | data source |
| [aws_secretsmanager_secret_version.miggo](https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/secretsmanager_secret_version) | data source |
...
| <a name="input_collector_image"></a> [collector\_image](#input\_collector\_image) | collector image name | `string` | `"miggo/collector"` | no |
...
| <a name="input_ecs_operator_s3"></a> [ecs\_operator\_s3](#input\_ecs\_operator\_s3) | Needed for fetching the lambda from Miggo s3 bucket | <pre>map({<br>    bucket  = string<br>    key     = string<br>    version = string<br>  })</pre> | n/a | yes |
